...
public class Cookies extends Patisserie {

    private String amountInPackage;

    public Cookies(String name, int price, Bitmap image, String amountInPackage,String id,float ratingAmount) {
        super(name, price, image,id,ratingAmount );
        this.amountInPackage = amountInPackage;
    }

    public Cookies(String name, int price, String amount) {
        super(name, price);
        this.amountInPackage = amount;
    }
    public Cookies(String name, int price, String amount,String id) {
        super(name, price,id);
        this.amountInPackage = amount;
    }

    public Cookies(String name, int price, String amountInPackage, String id, Long ratingAmount,double numOfVotes) {
